...
!(function(t, i) {
  ...
  function zi(t) {
    ...
    t.style &&
      (Mi(), (ei = (ii = t).style.outline), (t.style.outline = 'none'), Ei(window, 'keydown', Mi));
  }
  function Mi() {
    ...
    bt && 0 === i.indexOf('touch')
      ? (function(t, i, e) {
          ...
          'touchstart' === i
            ...
            : 'touchend' === i &&
              (t.removeEventListener(Ot, n, !1), t.removeEventListener(Rt, n, !1));
        })(t, i, o)
      : !Tt || 'dblclick' !== i || (bt && lt)
    ...
    Ji = k.extend({
      ...
      initialize: function(t, i) {
        (i = p(this, i)),
          ...
          this._zoomAnimated &&
            (this._createAnimProxy(), Ei(this._proxy, si, this._catchTransitionEnd, this)),
  ...
  var se,
    ...
    le = k.extend({
      ...
      finishDrag: function() {
        ...
        this._lastTarget &&
          (mi(this._lastTarget, 'leaflet-drag-target'), (this._lastTarget = null)),
        ue))
    ...
    $e = Se.extend({
      ...
      onAdd: function() {
        this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
          this.options.interactive &&
            (pi(this._image, 'leaflet-interactive'), this.addInteractiveTarget(this._image)),
      ...
      onRemove: function(t) {
        t._fadeAnimated
          ? (vi(this._container, 0),
            (this._removeTimeout = setTimeout(a(ui, void 0, this._container), 200)))
          : ui(this._container);
      },
      getLatLng: function() {
        return this._latlng;
  ...
  var un = an.extend({
    ...
    getTileUrl: function(t) {
      var i = this._tileCoordsToNwSe(t),
        ...
        o = n.min,
        s = n.max,
        r = (1.3 <= this._wmsVersion && this._crs === Me
          ? [o.y, o.x, s.y, s.x]
          : [o.x, o.y, s.x, s.y]
        ).join(','),
  ...
  Et && fn.include(pn),
    Ji.include({
      ...
      _getPaneRenderer: function(t) {
        ...
        return (
          void 0 === i && ((i = this._createRenderer({ pane: t })), (this._paneRenderers[t] = i)), i
        );
      },
